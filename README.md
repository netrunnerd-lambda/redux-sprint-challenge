...
The Store is the boss of the Redux operation. It holds the state and handles access to it. This is why it's the single source of truth. Reducers stand between the boss and the foot soldiers, Actions. They dictate how the state changes and pass that information along. Actions dictate what information is passed from the app to the reducer.

- [x] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Application state handles the bigger picture items like a list of messages or friends and the actions that are carried out on them. Component state is temporary, like form inputs.

- [x] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

Thunk allows us to call dispatch from our action creators rather than just returning plain JavaScript objects.
